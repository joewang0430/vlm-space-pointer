...
BAUD_RATE = 9600
GRID_SPACING = 80
TARGET_DESCRIPTION = "the polar bear plush toy"
MAX_ITERATIONS = 8
            ...
            "content": [
                {
                    ...
                    "text": (
                        ...
                        f"Compare its position to {target}. Return JSON: "
                        '{"laser_visible": <true/false>, "on_target": <true/false>, '
...
def main():
    ...
    coords = ask_vlm_target_location(client, "captures/loop_initial_grid.jpg", TARGET_DESCRIPTION, width, height)
    ...
    with serial.Serial(PORT, BAUD_RATE, timeout=2) as arduino:
        ...
        for iteration in range(1, MAX_ITERATIONS + 1):
            ...
            result = ask_vlm_direction(client, path, TARGET_DESCRIPTION)
